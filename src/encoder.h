...
// a particular concrete type inside should be replaced by their required
// concrete type.
//
// for example, when writing a property, the property value in the Get method is
// a variant at the DBus interface level, but should only actually be encoded
// with the actual concrete type declared for the property.
//
