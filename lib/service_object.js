...
/*
	...
	self.propertyInterface.addMethod('Get', { in: [ Utils.Define(String, 'interface_name'), Utils.Define(String, 'property_name') ], out: Utils.Define('Auto', 'value') }, function(callback) {
		self.propertyInterface.getProperty(callback);
	});

	self.propertyInterface.addMethod('Set', { in: [ Utils.Define(String, 'interface_name'), Utils.Define(String, 'property_name') , Utils.Define('auto', 'value') ] }, function(callback) {
		callback();
	});
	self.propertyInterface.addMethod('GetAll', { in: [ Utils.Define(String, 'interface_name') ], out: Utils.Define(Object, 'properties') }, function(callback) {

		self.propertyInterface.getProperties(callback);
	});
